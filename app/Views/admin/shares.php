...
<div class="mb-6 flex flex-col sm:flex-row gap-4">
    ...
    <a href="<?= \App\Helpers\Url::appUrl() ?>/shares/export" 
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Amount per Share</th>
                ...
                <?php if (!empty($shares)): ?>
                    <?php foreach ($shares as $share): ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-primary/10 text-blue-800">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?= ($share['payment_method'] ?? '') === 'paystack' ? 'bg-primary/10 text-blue-800' : 'bg-gray-100 text-gray-800' ?>">
                                    <?= ucfirst(htmlspecialchars($share['payment_method'] ?? 'manual')) ?>
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                <?= date('M d, Y H:i', strtotime($share['purchased_at'] ?? $share['purchase_date'] ?? '')) ?>
                            </td>
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-lg font-medium text-gray-900 mb-2">No shares purchases found</p>
