...
<div class="mb-8">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-gray-600">Create a new event for your organization</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600 mt-1">Fill in the details for the new event</p>
    </div>

    <form method="POST" action="<?= \App\Helpers\Url::appUrl() ?>/events/add" class="space-y-6">
